...
var gallery = new Class({
	...
	populateData: function() {
		...
		data = this.galleryData;
                ...
                for (currentArrayPlace = 0 ; currentArrayPlace < lbSize ; currentArrayPlace++) {
                    
			elementDict = {
				image: lbImage[currentArrayPlace],
				number: currentArrayPlace
			};
			if ((options.showInfopane) | (options.showCarousel))
				Object.extend(elementDict, {
					title: lbTitle[currentArrayPlace],
					description: lbDescription[currentArrayPlace]
				});
			if (options.embedLinks)
				Object.extend(elementDict, {
					link: lbLink[currentArrayPlace]||false,
					linkTitle: false
				});
			if (options.showCarousel)
				Object.extend(elementDict, {
					thumbnail: lbThumb[currentArrayPlace]
				});

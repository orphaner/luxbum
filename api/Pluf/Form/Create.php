...
/**
 * Create form automatically generated from the model definition.
 */
class Pluf_Form_Create extends Pluf_Form
{
    ...
    function save($data)
    {
        ...
        // create will throw an exception if impossible to create
        $this->model->create();
        return $this->model;
    }
}

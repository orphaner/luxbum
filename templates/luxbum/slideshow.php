...
<body>
  ...
  <div id="slide">
    ...
    <div id="s_options_box">
      <h2>Options</h2>
      <input type="checkbox" id="smoothtrans" checked="checked"/> Activer le fondu<br />
      <input type="text" id="slide_speed" size="1" maxlength="1" value="4" /> Temps entre chaque photo (en secondes) <br />
    </div>
